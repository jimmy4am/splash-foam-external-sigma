...
import { getPoints } from "@/app/_components/review/review-5/review-body/utils";
  ...
  return (
    <section className={`py-[20px] md:py-[60px] bg-[#f6fbff] ${inter.className}`}>
      <div className="md:flex md:flex-wrap md:justify-between w-full max-w-[1200px] mx-[auto] px-4">
        <div className="md:flex-[0_0_55%] lg:flex-[0_0_65.81%] mb-[25px] md:mb-[0px]">
        ...
        <div className="md:flex-[1_1_auto] mt-[70px] md:mt-[50px]">
          <ReviewCard
            number={1}
