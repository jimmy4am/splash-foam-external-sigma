    ...
    <div className="flex flex-col items-center mt-6">
      <div className="relative w-40 h-40">
        <Image
          ...
          width={160}
          height={160}
          className="rounded-full border-2 border-white object-cover z-10 absolute inset-0 aspect-square"
        />
      </div>
      <div
        className="relative w-full h-20 mt-[-40px] mb-[-10px] bg-center bg-cover flex justify-center items-center"
        style={{
          backgroundImage:
            "url('https://imagedelivery.net/3TTaU3w9z1kOYYtN3czCnw/3fafebec-09d3-4d87-0b68-34761c120e00/public')",
        }}
      />
      <div className="bg-blue-100/80 shadow-xl w-full p-4 flex flex-col items-center rounded-md px-6 mb-6">
        <h5 className="py-2 font-bold text-xl uppercase text-center">{name}</h5>
        <p className="font-bold text-gray-500 uppercase text-center">
          {location}
        </p>
...
const AdvetorialBody2 = ({
  ...
  return (
    <div className="flex w-full justify-center md:p-4 bg-blue-100/70 md:pb-8">
      <div className="flex w-full max-w-[1250px] justify-start items-start pt-2 md:py-8 bg-white md:rounded-md flex-wrap md:px-8">
        <div className="flex flex-1 flex-col justify-start items-center px-4">
          ...
          <div className="flex w-full justify-center items-center py-2 px-2">
            <div className="flex items-center text-[14px]">
              <EyeIcon className="h-4 w-4 mr-2 text-[#555]" />
              <p className="text-[#777]">290,153 views</p>{" "}
              <span className="px-3">/</span>{" "}
              <p className="text-[#777]">
                <span className="text-red-500 animate-pulse">◉</span>
                <span className="text-red-500 font-bold"> 693</span> Live
                Viewers
              </p>
            </div>
          </div>
        ...
        <div className="w-full xl:flex xl:w-[350px] flex-col justify-start items-center px-4 xl:h-full ">
          <div className="mt-12 mb-12 flex xl:hidden w-full justify-center items-center bg-[#ddd] h-1" />

          <div className="flex flex-col pb-4 xl:sticky top-0  max-w-full">
            <div className="flex flex-col items-center">
              <div className="hidden xl:flex w-[5px] h-[50px] bg-[#fb4948] mt-[-20px]" />

              {post.product1?.reviews?.name1 && (
                <div className="flex flex-col items-center">
                  <h4 className="font-bold text-[17px]  w-full uppercase text-[#fb4948] text-center">
                    Happy Customer Reviews
                  </h4>
                  <>
                    <IndivReview
                      name={post.product1.reviews.name1}
                      location={post.product1.reviews.location1}
                      image={post.product1.reviews.image1}
                  ...
                  {post.product1?.reviews?.name2 && (
                    <>
                      <IndivReview
                        ...
                        location={post.product1.reviews.location2}
                        image={post.product1.reviews.image2}
                  ...
                  {post.product1?.reviews?.name3 && (
                    <>
                      <IndivReview
                        ...
                        location={post.product1.reviews.location3}
                        image={post.product1.reviews.image3}
                  ...
                  {post.product1?.reviews?.name4 && (
                    <>
                      <IndivReview
                        ...
                        location={post.product1.reviews.location4!}
                        image={post.product1.reviews.image4!}
                  ...
                  {post.product1?.reviews?.name5 && (
                    <>
                      <IndivReview
                        ...
                        location={post.product1.reviews.location5!}
                        image={post.product1.reviews.image5!}
...
export default AdvetorialBody2;
