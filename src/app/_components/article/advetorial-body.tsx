...
const AdvetorialBody = ({
  ...
  return (
    <div className="flex w-full justify-center md:p-4 bg-blue-100/70 md:pb-8">
      <div className="flex w-full max-w-[1250px] justify-start items-start py-4 bg-white rounded-md flex-wrap md:px-6">
