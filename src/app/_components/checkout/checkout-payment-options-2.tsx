...
import {
    GlobeAmericasIcon,
    LockClosedIcon,
    ChevronDownIcon, CheckCircleIcon, ExclamationTriangleIcon, Squares2X2Icon,
        ...
        <>
            {loading && (
                <div className="fixed h-screen w-screen top-0 left-0 z-40 flex justify-center items-center bg-black/20">
                    <div
                        className="flex bg-blue-500 text-white p-4 rounded-md flex-col items-center justify-center w-[280px] h-[140px] text-[18px] font-[500]">
            ...
            <div className="hidden lg:flex w-full items-center mb-6">
                ...
                <div>
                    <h3 className="text-[23px] leading-[25px] sm:text-[26px] sm:leading-[26px] lg:text-[28px] lg:leading-[28px] font-bold">Payment Information</h3>
                    <p className="text-[14px] leading-[20px] lg:text-[15px] lg:leading-[21px]">Safe & Secure Checkout</p>
                </div>
            </div>
            <form onSubmit={formik.handleSubmit}>
                ...
                <div className="flex w-full items-center mb-6">
                    <GlobeAmericasIcon className="h-[40px] w-[40px] mr-2"/>
                    <div>
                        <h3
                            className="text-[23px] leading-[25px] sm:text-[26px] sm:leading-[26px] lg:text-[28px] lg:leading-[28px] font-bold">Shipping
                            Information</h3>
                        <p className="text-[14px] leading-[20px] lg:text-[15px] lg:leading-[21px]">Where do we send your splash
                            foam?</p>
                    </div>
                </div>
                ...
                <div className="flex w-full space-x-4 mt-4">
                    <div className="flex w-full flex-col items-start justify-start relative">
                        <label className="flex text-[16px] leading-[18px] mb-2">Country</label>
                        <div className="relative w-full">
                            <select
                                onChange={handleCountryChange}
                                className="w-full h-[50px] border-[1px] border-[#a7abad] px-1 py-2 text-[14px] rounded bg-[#fff] outline-none focus:shadow-[0_0_5px_0_#51cbee] focus:border-[#51cbee]"
                ...
                <div className="flex w-full space-x-4 mt-6">
                    <div className="flex w-full flex-col items-start justify-start">
                        <label className="flex text-[16px] leading-[18px] mb-2">
                            Delivery Address
                        </label>
                        <div className="relative w-full">
                            <input
                    ...
                    ${formik.touched.address && formik.errors.address ? 'border-[orange]' : null}`}
                                placeholder="Address"
                            />
                            {formik.touched.address && !formik.errors.address ? (
                                <CheckCircleIcon
                                    className="text-[green] absolute right-[10px] top-[25px] -translate-y-[50%] w-[18px] h-[18px]"/>
                            ) : null}
                            {formik.touched.address && formik.errors.address ? (
                                <div className="text-[orange] text-xs">
                                    <ExclamationTriangleIcon
                                        className="absolute right-[10px] top-[25px] -translate-y-[50%] w-[18px] h-[18px]"/>
                        ...
                        <input
                            ...
                            className="w-full h-[50px] mt-2 border-[1px] border-[#a7abad] px-1 py-2 text-[14px] rounded outline-none focus:shadow-[0_0_5px_0_#51cbee] focus:border-[#51cbee]"
                ...
                <div className="flex w-full space-x-4 mt-6">
                    <div className="flex w-full flex-col items-start justify-start">
                        <label className="flex text-[16px] leading-[18px] mb-2">City</label>
                        <div className="relative w-full">
                            <input
                                type="text"
                                name="city"
                                ...
                                className={`w-full h-[50px] border-[1px] border-[#a7abad] px-1 py-2 text-[14px] rounded outline-none focus:shadow-[0_0_5px_0_#51cbee] focus:border-[#51cbee]
                    ${formik.touched.city && formik.errors.city ? 'border-[orange]' : null}`}
                                placeholder="City"
                            />
                    ...
                    <div className="flex w-1/2 flex-col items-start justify-start">
                        ...
                        <div className="relative w-full">
                            <input
                                ...
                                className={`w-full h-[50px] border-[1px] border-[#a7abad] px-1 py-2 text-[14px] rounded outline-none focus:shadow-[0_0_5px_0_#51cbee] focus:border-[#51cbee]
                    ${formik.touched.zip && formik.errors.zip ? 'border-[orange]' : null}`}
                ...
                <div className="flex w-full space-x-4 mt-6">
                    <div className="flex w-full flex-col items-start justify-start">
                        <label className="flex text-[16px] leading-[18px] mb-2">Shipping</label>
                        <div className="flex">
                            <input
                                type="radio"
                                name="shipping"
                ...
                <div className="flex w-full space-x-4 mt-6">
                    <div className="flex w-full flex-col items-start justify-start">
                        <label className="flex text-[16px] leading-[18px] mb-2">Card Number</label>
                        <div className="relative w-full">
                            <input
                                type="text"
                                name="card"
                                ...
                                pattern="\d*"
                                className={`w-full h-[50px] border-[1px] border-[#a7abad] px-1 py-2 text-[14px] rounded outline-none focus:shadow-[0_0_5px_0_#51cbee] focus:border-[#51cbee]
                    ${formik.touched.card && formik.errors.card ? 'border-[orange]' : null}`}
                ...
                <div className="flex w-full space-x-4 mt-4">
                    <div className="flex w-1/2 flex-col items-start justify-start relative">
                        <label className="flex text-[16px] leading-[18px] mb-2">Expiry Month</label>
                        <div className="relative w-full">
                            <select
                                name="month"
                                onChange={formik.handleChange}
                                ...
                                className={`w-full h-[50px] bg-[#fff] border-[1px] border-[#a7abad] px-1 py-2 text-[14px] rounded outline-none focus:shadow-[0_0_5px_0_#51cbee] focus:border-[#51cbee]
                    ${formik.touched.month && formik.errors.month ? 'border-[orange]' : null}`}
                            >
                ...
                <ChevronDownIcon className="w-4 h-4 text-[#555] "/>
                        ...
                        {formik.touched.month && formik.errors.month ? (
                            <div className="text-[orange] text-xs">{formik.errors.month}</div>
                        ) : null}
                    </div>
                    <div className="flex w-1/2 flex-col items-start justify-start">
                        <label className="flex text-[16px] leading-[18px] mb-2">Expiry Year</label>
                        <div className="relative w-full">
                            <select
                                name="year"
                                onChange={formik.handleChange}
                                ...
                                className={`w-full h-[50px] bg-[#fff] border-[1px] border-[#a7abad] px-1 py-2 text-[14px] rounded outline-none focus:shadow-[0_0_5px_0_#51cbee] focus:border-[#51cbee]
                    ${formik.touched.year && formik.errors.year ? 'border-[orange]' : null}`}
                            >
                                <option disabled value="" className="text-[#ccc]">
                                    Year
                                </option>
                ...
                <ChevronDownIcon className="w-4 h-4 text-[#555]"/>
                        ...
                        {formik.touched.year && formik.errors.year ? (
                            <div className="text-[orange] text-xs">{formik.errors.year}</div>
                        ) : null}
                    </div>
                </div>
                <div className="flex w-full space-x-4 mt-6 mb-6">
                    <div className="flex w-full flex-col items-start justify-start">
                        <label className="flex text-[16px] leading-[18px] mb-2">CVV</label>
                        <div className="relative w-full">
                            <input
                                type="text"
                                name="cvv"
                                ...
                                pattern="\d*"
                                className={`w-full h-[50px] border-[1px] border-[#a7abad] px-1 py-2 text-[14px] rounded outline-none focus:shadow-[0_0_5px_0_#51cbee] focus:border-[#51cbee]
                    ${formik.touched.cvv && formik.errors.cvv ? 'border-[orange]' : null}`}
                                placeholder="CVV"
                            />
