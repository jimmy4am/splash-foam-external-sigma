...
import SalesStepsSingleItemEdit from "@/app/_components/sales/sales-4/sales-steps/sales-steps-single-item-edit";
  ...
  return (
    <AppSection classes="bg-[#e7f4f9]">
      ...
      <div className="w-full max-w-[1080px] mx-[auto] flex flex-col md:flex-row gap-[20px] lg:gap-[30px] xl:gap-[40px] mb-[10px]">
        <SalesStepsSingleItemEdit
          step={1}
          info={info}
          setCurrentPost={setCurrentPost}
          img={info.splitcompare.step1Img}
          imgField="splitcompare.step1Img"
          title={info.splitcompare.step1Title}
          titleField="step1Title"
          text={info.splitcompare.step1Text}
          textField="step1Text"
        />
        <SalesStepsSingleItemEdit
          step={2}
          info={info}
          setCurrentPost={setCurrentPost}
          img={info.splitcompare.step2Img}
          imgField="splitcompare.step2Img"
          title={info.splitcompare.step2Title}
          titleField="step2Title"
          text={info.splitcompare.step2Text}
          textField="step2Text"
        />
        <SalesStepsSingleItemEdit
          step={3}
          info={info}
          setCurrentPost={setCurrentPost}
          img={info.splitcompare.step3Img}
          imgField="splitcompare.step3Img"
          title={info.splitcompare.step3Title}
          titleField="step3Title"
          text={info.splitcompare.step3Text}
          textField="step3Text"
        />
      </div>
