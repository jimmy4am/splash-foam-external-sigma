                ...
                <div className="flex flex-col md:flex-row-reverse md:justify-between">
                    ...
                    <div className="md:w-[58%] lg:w-[55%] flex flex-col items-center md:items-start">
                        <div className="flex items-center justify-center gap-[8px] md:gap-[10px] mb-[16px] md:mb-[20px]">
                            <Image className="w-[75px] md:w-[105px]" src="https://imagedelivery.net/3TTaU3w9z1kOYYtN3czCnw/49253e46-369e-4742-d9f4-c870b1722100/public" alt={siteProduct} width={75}  height={12}  />
