...
const SpecGridRow = ({ text, icon }: SpecGridRowProps) => {
  return (
    <div className="flex w-full border-t-[1px] border-[#dcdcdc]">
      <div className="w-1/2 lg:w-1/3 flex items-center justify-start p-2">
        <Image
          src={icon}
          width={45}
          height={45}
      ...
      <div className="w-1/4 justify-center lg:w-1/3 flex items-center md:justify-start p-2 text-[16px] lg:text-[20px] font-bold text-[#005279] border-r-[1px] border-l-[1px] border-[#dcdcdc]">
      ...
      <div className="w-1/4 justify-cetner lg:w-1/3 flex items-center md:justify-start p-2 text-[16px] lg:text-[20px] font-bold text-[#333] ">
    ...
    <div className="flex flex-col items-center w-full pb-6 z-10">
      ...
      >
        ...
        <div className="flex flex-col w-full rounded-lg spec-grid-shadow mt-10 bg-white">
          ...
          <SpecGridRow text={info.specgrid.text1} icon={info.specgrid.icon1} />
          <SpecGridRow text={info.specgrid.text2} icon={info.specgrid.icon2} />
          <SpecGridRow text={info.specgrid.text3} icon={info.specgrid.icon3} />
          <SpecGridRow text={info.specgrid.text4} icon={info.specgrid.icon4} />
          <SpecGridRow text={info.specgrid.text5} icon={info.specgrid.icon5} />
          <SpecGridRow text={info.specgrid.text6} icon={info.specgrid.icon6} />
          <SpecGridRow text={info.specgrid.text7} icon={info.specgrid.icon7} />
        </div>
