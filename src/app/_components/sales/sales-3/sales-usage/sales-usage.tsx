...
const SalesUsage = ({ info }: Props) => {
    const settings = {
        ...
        slidesToScroll: 1,
        arrows: true,
        nextArrow: <button><Image className="" src="/images/template-3/usage-slider-next-arrow.png" width={38} height={38} alt="Next slide icon" /></button>,
        prevArrow: <button><Image className="" src="/images/template-3/usage-slider-prev-arrow.png" width={38} height={38} alt="Prev slide icon" /></button>,
        responsive: [{
            breakpoint: 1200,
            settings: {
                slidesToShow:3,
