...
import SalesUsageSingleItemEdit from "@/app/_components/sales/sales-3/sales-usage/sales-usage-single-item-edit";
    ...
    <AppSection classes={`bg-[#fff] ${inter.className}`}>
      ...
      <div className="-mx-4 md:mx-0">
        <Slider className="usage-slider slider" {...settings}>
          <SalesUsageSingleItemEdit info={info} setCurrentPost={setCurrentPost} image={info.fiveimagesplit.img1} imageField="fiveimagesplit.img1" title={info.fiveimagesplit.text1} titleField="text1" />
          <SalesUsageSingleItemEdit info={info} setCurrentPost={setCurrentPost} image={info.fiveimagesplit.img2} imageField="fiveimagesplit.img2" title={info.fiveimagesplit.text2} titleField="text2" />
          <SalesUsageSingleItemEdit info={info} setCurrentPost={setCurrentPost} image={info.fiveimagesplit.img3} imageField="fiveimagesplit.img3" title={info.fiveimagesplit.text3} titleField="text3" />
          <SalesUsageSingleItemEdit info={info} setCurrentPost={setCurrentPost} image={info.fiveimagesplit.img4} imageField="fiveimagesplit.img4" title={info.fiveimagesplit.text4} titleField="text4" />
          <SalesUsageSingleItemEdit info={info} setCurrentPost={setCurrentPost} image={info.fiveimagesplit.img5} imageField="fiveimagesplit.img5" title={info.fiveimagesplit.text5} titleField="text5" />
        </Slider>
      </div>
